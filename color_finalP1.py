...
#              single shot of 50 frmaes or run the camera continuously. The images 
...
#              xy.txt    (The angle that the object is in relation to e.DO in cm) 
...
while True:
    ...
    while True:
        ...
        while(count >= 0):
          ...
          _, img = cap.read()
          # Crop image to a desireable size (Captures table where object would be placed) 
